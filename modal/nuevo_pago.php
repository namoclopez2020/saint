<div class="modal" id="myModalpago" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
    <div class="modal-dialog modal-sm col-10 mx-auto modal-dialog-centered ">
